...
namespace VetAPIService.Controllers
{
    ...
    public class VetsController : ControllerBase
    {
        ...
        [HttpGet("Prescription/App/{id}")]
        [Produces(typeof(List<PrescriptionApiModel>))]
        public async Task<ActionResult<PrescriptionApiModel>> GetPrescriptionByAppAsync(int id)
        {
            try
            {
                var prescription = await _managerPrescription.GetAllPrescriptionbyAppAsync(id);
                if (prescription == null)
                {
                    return NotFound();
                }
        ...
        [HttpGet("Symptom/App/{id}")]
        [Produces(typeof(List<SymptomApiModel>))]
        public async Task<ActionResult<SymptomApiModel>> GetSymptomByAppAsync(int id)
        {
            try
            {
                var symptom = await _managerSymptom.GetSymptomByAppIdAsync(id);
                if (symptom == null)
                {
                    return NotFound();
                }
        ...
        [HttpGet("Test/App/{id}")]
        [Produces(typeof(List<TestApiModel>))]
        public async Task<ActionResult<TestApiModel>> GetTestByAppAsync(int id)
        {
            try
            {
                var test = await _managerTest.GetTestByAppIdAsync(id);
                if (test == null)
                {
                    return NotFound();
                }
        ...
        [HttpGet("Vital/App/{id}")]
        [Produces(typeof(List<VitalApiModel>))]
        public async Task<ActionResult<VitalApiModel>> GetVitalByAppAsync(int id)
        {
            try
            {
                var vital = await _managerVital.GetVitalByAppIdAsync(id);
                if (vital == null)
                {
                    return NotFound();
                }
